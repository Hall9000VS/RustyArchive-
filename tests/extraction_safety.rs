...
#[test]
fn rejects_nested_rustyarchive_metadata_paths() {
    let error = validate_manifest_path("subdir/.rustyarchive/manifest.json")
        .expect_err("metadata path should be reserved at any depth");
